...
public class Dispos {
    private Journée date;
    private int[] heureDebut;
    private int[] heureFin;

    public Dispos(Journée date, int[] heureDebut, int[] heureFin) throws IllegalArgumentException {
        ...
        }else if ((heureDebut[0] == heureFin[0] && heureDebut[1] >= heureFin[1])) {
